package Number::Phone::NANP::TT;

# numbering plan at http://www.itu.int/itudoc/itu-t/number/t/tto/79162.html
...
Number::Phone::NANP::TT - TT-specific methods for Number::Phone

=head1 DESCRIPTION

This class implements TT-specific methods for Number::Phone.  It is
...
sub regulator { 'RIC, http://www.ric.org.tt/'; }
