package Number::Phone::NANP::DM;

# numbering plan at http://www.itu.int/itudoc/itu-t/number/d/dma/81906.html
...
Number::Phone::NANP::DM - DM-specific methods for Number::Phone

=head1 DESCRIPTION

This class implements DM-specific methods for Number::Phone.  It is
...
=head1 SYNOPSIS
    ...
    my $phone_number = Number::Phone->new('+1 767 448 1408');
    # returns a Number::Phone::NANP::DM object
