...
Number::Phone::NANP::AG - AG-specific methods for Number::Phone

=head1 DESCRIPTION

This class implements AG-specific methods for Number::Phone.  It is
...
=head1 SYNOPSIS
    ...
    my $phone_number = Number::Phone->new('+1 268 480 4000');
    # returns a Number::Phone::NANP::AG object
