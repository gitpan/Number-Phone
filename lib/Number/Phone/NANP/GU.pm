...
Number::Phone::NANP::GU - GU-specific methods for Number::Phone

=head1 DESCRIPTION

This class implements GU-specific methods for Number::Phone.  It is
...
=head1 SYNOPSIS
    ...
    my $phone_number = Number::Phone->new('+1 671 632 3365');
    # returns a Number::Phone::NANP::GU object
...
sub regulator { 'GTA, http://www.gtaguam.com/'; }
