package Number::Phone::NANP::KY;

# numbering plan at http://www.itu.int/itudoc/itu-t/number/c/cym/80988.html
...
Number::Phone::NANP::KY - KY-specific methods for Number::Phone

=head1 DESCRIPTION

This class implements KY-specific methods for Number::Phone.  It is
...
=head1 SYNOPSIS
    ...
    my $phone_number = Number::Phone->new('+1 345 945 8284');
    # returns a Number::Phone::NANP::KY object
...
sub regulator { 'ICTA, http://www.icta.ky/'; }
