package Number::Phone::NANP::TC;

# numbering plan at http://www.itu.int/itudoc/itu-t/number/t/tcs/81522.html
...
Number::Phone::NANP::TC - TC-specific methods for Number::Phone

=head1 DESCRIPTION

This class implements TC-specific methods for Number::Phone.  It is
...
=head1 SYNOPSIS
    ...
    my $phone_number = Number::Phone->new('+1 649 946 5231');
    # returns a Number::Phone::NANP::TC object
