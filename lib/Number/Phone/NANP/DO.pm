package Number::Phone::NANP::DO;

# numbering plan at http://www.itu.int/itudoc/itu-t/number/d/dom/81947.html
...
Number::Phone::NANP::DO - DO-specific methods for Number::Phone

=head1 DESCRIPTION

This class implements DO-specific methods for Number::Phone.  It is
...
=head1 SYNOPSIS
    ...
    my $phone_number = Number::Phone->new('+1 809 547 1000');
    # returns a Number::Phone::NANP::DO object
...
sub regulator { 'Indotel, http://indotel.org.do/'; }
