...
my $validators = {'special_rate' => '()|()|()','personal_number' => '','voip' => '56\\d{4}','toll_free' => '','fixed_line' => '(?:2[1-3]|3[0-7]|4\\d|5[2-58]|68\\d)\\d{4}','mobile' => '(?:7(?:[1-357]\\d|4[0-5])|8[1-9]\\d)\\d{4}','geographic' => '(?:2[1-3]|3[0-7]|4\\d|5[2-58]|68\\d)\\d{4}','pager' => ''};
sub new {
  my $class = shift;
  my $number = shift;
  $number =~ s/(^\+597|\D)//g;
