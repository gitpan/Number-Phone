...
my $validators = {'toll_free' => '','personal_number' => '','mobile' => '(?:7(?:[1-357]\\d|4[0-5])|8[1-9]\\d)\\d{4}','geographic' => '(?:2[1-3]|3[0-7]|4\\d|5[2-58]|68\\d)\\d{4}','special_rate' => '()|()|()','voip' => '56\\d{4}','fixed_line' => '(?:2[1-3]|3[0-7]|4\\d|5[2-58]|68\\d)\\d{4}','pager' => ''};
sub new {
  my $class = shift;
  my $number = shift;
  $number =~ s/(^\+597|\D)//g;
