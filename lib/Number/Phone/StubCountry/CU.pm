...
my $validators = {'mobile' => '5\\d{7}','special_rate' => '()|()|()','geographic' => '2[1-4]\\d{5,6}|3(?:1\\d{6}|[23]\\d{4,6})|4(?:[125]\\d{5,6}|[36]\\d{6}|[78]\\d{4,6})|7\\d{6,7}','pager' => '','toll_free' => '','fixed_line' => '2[1-4]\\d{5,6}|3(?:1\\d{6}|[23]\\d{4,6})|4(?:[125]\\d{5,6}|[36]\\d{6}|[78]\\d{4,6})|7\\d{6,7}','voip' => '','personal_number' => ''};sub areaname { my $self = shift; my $number = $self->{number}; my %map = (5321 => "Guant\Ã\¡namo\ Province",5322 => "Santiago\ de\ Cuba\ Province",5323 => "Granma\ Province",5324 => "Holgu\Ã\­n\ Province",5331 => "Las\ Tunas\ Province",5332 => "Camag\Ã\¼ey\ Province",5333 => "Ciego\ de\ \Ã\vila\ Province",5341 => "Sancti\ Sp\Ã\­ritus\ Province",5342 => "Villa\ Clara\ Province",5343 => "Cienfuegos\ Province",5345 => "Matanzas\ Province",5346 => "Isle\ of\ Youth",5347 => "Havana\ Province",5348 => "Pinar\ del\ R\Ã\­o\ Province",537 => "Havana\ City",);
