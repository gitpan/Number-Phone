...
my $validators = {'toll_free' => '80[05]\\d{4}','mobile' => '9[1-9]\\d{6}','voip' => '','fixed_line' => '2\\d{7}|4[2-7]\\d{6}','special_rate' => '()|(90[0-8]\\d{4})|()','personal_number' => '','pager' => '','geographic' => '2\\d{7}|4[2-7]\\d{6}'};
sub new {
  my $class = shift;
  my $number = shift;
  $number =~ s/(^\+598|\D)//g;
