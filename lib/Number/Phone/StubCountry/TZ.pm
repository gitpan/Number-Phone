...
my $validators = {'toll_free' => '80[08]\\d{6}','mobile' => '(?:6[158]|7[1-9])\\d{7}','voip' => '41\\d{7}','fixed_line' => '2[2-8]\\d{7}','special_rate' => '(8(?:40|6[01])\\d{6})|(90\\d{7})|()','personal_number' => '','pager' => '','geographic' => '2[2-8]\\d{7}'};
sub new {
  my $class = shift;
  my $number = shift;
  $number =~ s/(^\+255|\D)//g;
