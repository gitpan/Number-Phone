...
my $validators = {'personal_number' => '701\\d{4}','toll_free' => '80(?:0(?:2[238]|79)|9\\d{2})\\d{2}','pager' => '','mobile' => '6(?:51[01]|6(?:[01][0-4]|2[016-9]|88)|710)\\d{5}|7(?:36|4[25]|56|[7-9]\\d)\\d{4}','voip' => '','fixed_line' => '(?:2(?:01|1[27]|3\\d|6[02-578]|96)|3(?:7[0135-7]|8[048]|9[0269]))\\d{4}','special_rate' => '()|(90(?:0(?:2[278]|79)|1(?:23|3[012])|6(?:4\\d|6[0126]))\\d{2})|(87(?:0[128]|7[0-4])\\d{3})'};
sub new {
  my $class = shift;
  my $number = shift;
  $number =~ s/(^\+423|\D)//g;
