...
my $validators = {'special_rate' => '(8[12]\\d{6})|(9[0246]\\d{6})|(70[23]\\d{5})','personal_number' => '','pager' => '','voip' => '','mobile' => '6(?:03|44|71|[1-356])\\d{6}','toll_free' => '8[08]\\d{6}','fixed_line' => '(?:[35]\\d|49)\\d{6}'};
sub new {
  my $class = shift;
  my $number = shift;
  $number =~ s/(^\+387|\D)//g;
