...
my $validators = {'toll_free' => '','mobile' => '7[3-9]\\d{8}','voip' => '','fixed_line' => '1\\d{7}|(?:2[13-5]|3[02367]|4[023]|5[03]|6[026])\\d{6,7}','special_rate' => '()|()|()','personal_number' => '','pager' => '','geographic' => '1\\d{7}|(?:2[13-5]|3[02367]|4[023]|5[03]|6[026])\\d{6,7}'};
sub new {
  my $class = shift;
  my $number = shift;
  $number =~ s/(^\+964|\D)//g;
