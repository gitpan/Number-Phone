...
my $validators = {'mobile' => '7[3-9]\\d{8}','geographic' => '1\\d{7}|(?:2[13-5]|3[02367]|4[023]|5[03]|6[026])\\d{6,7}','toll_free' => '','personal_number' => '','special_rate' => '()|()|()','fixed_line' => '1\\d{7}|(?:2[13-5]|3[02367]|4[023]|5[03]|6[026])\\d{6,7}','voip' => '','pager' => ''};
sub new {
  my $class = shift;
  my $number = shift;
  $number =~ s/(^\+964|\D)//g;
