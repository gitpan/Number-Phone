...
my $validators = {'personal_number' => '8[1-3]\\d{6}','toll_free' => '800\\d{6}','pager' => '7\\d{7}','mobile' => '(?:5[1-69]\\d|6\\d{2}|9(?:0[1-9]|[1-8]\\d))\\d{5}','voip' => '','fixed_line' => '(?:[23]\\d|5[78])\\d{6}','special_rate' => '()|(900(?:[0-24-9]\\d{7}|3\\d{1,4}))|()'};
sub new {
  my $class = shift;
  my $number = shift;
  $number =~ s/(^\+852|\D)//g;
