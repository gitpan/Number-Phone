...
my $validators = {'personal_number' => '','toll_free' => '800\\d{6}|1230\\d{7}','pager' => '','mobile' => '9[6-9]\\d{7}','voip' => '44\\d{7}','fixed_line' => '(?:2|32|41)\\d{7}|(?:3[3-5]|4[235]|5[1-3578]|6[13-57]|7[1-35])\\d{6,7}','special_rate' => '(600\\d{7,8})|()|()'};sub areaname { my $self = shift; my $number = $self->{number}; my %map = (562 => 'Santiago',5632 => 'Valpara\Ã\­so',5633 => 'Quillota',5635 => 'San\ Antonio',5641 => 'Concepci\Ã\³n',5642 => 'Chill\Ã\¡n',5643 => 'Los\ Angeles',5645 => 'Temuco',5651 => 'Coquimbo',5652 => 'Copiap\Ã\³',5653 => 'Ovalle',5655 => 'Antofagasta',5657 => 'Iquique',5658 => 'Arica',5661 => 'Punta\ Arenas',5663 => 'Valdivia',5664 => 'Osorno',5665 => 'Puerto\ Montt',5671 => 'Talca',5672 => 'Rancagua',5673 => 'Linares',5675 => 'Curic\Ã\³',);
