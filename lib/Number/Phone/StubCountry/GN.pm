...
my $formatters = [{'leading_digits' => '3','pattern' => '(\\d{2})(\\d{2})(\\d{2})(\\d{2})'},{'pattern' => '(\\d{3})(\\d{2})(\\d{2})(\\d{2})','leading_digits' => '[67]'}];
my $validators = {'pager' => '','fixed_line' => '30(?:24|3[12]|4[1-35-7]|5[13]|6[189]|[78]1|9[1478])\\d{4}','voip' => '722\\d{6}','special_rate' => '()|()|()','geographic' => '30(?:24|3[12]|4[1-35-7]|5[13]|6[189]|[78]1|9[1478])\\d{4}','personal_number' => '','mobile' => '6[02356]\\d{7}','toll_free' => ''};sub areaname { my $self = shift; my $number = $self->{number}; my %map = (2243024 => "Fria",2243031 => "Bok\Ã\©",2243032 => "Kamsar",2243041 => "Conakry",2243042 => "Conakry",2243043 => "Conakry",2243045 => "Conakry",2243046 => "Boussoura",2243047 => "Conakry",2243051 => "Lab\Ã\©",2243053 => "Pita",2243061 => "Kindia",22430613 => "T\Ã\©lim\Ã\©l\Ã\©",2243068 => "Mamou",2243069 => "Dalaba",2243071 => "Kankan",2243081 => "Faranah",2243091 => "N\'Z\Ã\©r\Ã\©kor\Ã\©",2243094 => "Macenta",2243097 => "Gu\Ã\©ck\Ã\©dou",2243098 => "Kissidougou",);
