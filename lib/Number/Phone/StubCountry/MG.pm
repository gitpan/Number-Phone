...
my $validators = {'toll_free' => '','mobile' => '3[2-49]\\d{7}','voip' => '22\\d{7}','fixed_line' => '20(?:2\\d{2}|4[47]\\d|5[3467]\\d|6[279]\\d|7(?:2[29]|[35]\\d)|8[268]\\d|9[245]\\d)\\d{4}','special_rate' => '()|()|()','personal_number' => '','pager' => '','geographic' => '20(?:2\\d{2}|4[47]\\d|5[3467]\\d|6[279]\\d|7(?:2[29]|[35]\\d)|8[268]\\d|9[245]\\d)\\d{4}'};sub areaname { my $self = shift; my $number = $self->{number}; my %map = (2612022 => "Antananarivo",2612042 => "Ambatolampy",2612044 => "Antsirabe",2612047 => "Ambositra",2612048 => "Mid\-West\ Madagascar",2612053 => "Toamasina",2612054 => "Ambatondrazaka",2612056 => "Moramanga",2612057 => "Maroantsetra\/Sainte\ Marie",2612062 => "Mahajanga",2612067 => "Antsohihy",2612069 => "Maintirano",26120722 => "Manakara",26120729 => "Mananjary",2612073 => "Farafangana",2612075 => "Fianarantsoa",2612082 => "Antsiranana",2612086 => "Nosy\ Be",2612088 => "Sambava",2612092 => "Taola\Ã\±aro",2612094 => "Toliary",2612095 => "Morondava",);
