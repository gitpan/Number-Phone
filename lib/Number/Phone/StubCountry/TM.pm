...
my $validators = {'fixed_line' => '(?:1(?:2\\d|3[1-9])|2(?:22|4[0-35-8])|3(?:22|4[03-9])|4(?:22|3[128]|4\\d|6[15])|5(?:22|5[7-9]|6[014-689]))\\d{5}','toll_free' => '','voip' => '','mobile' => '6[2-8]\\d{6}','pager' => '','personal_number' => '','special_rate' => '()|()|()'};
sub new {
  my $class = shift;
  my $number = shift;
  $number =~ s/(^\+993|\D)//g;
