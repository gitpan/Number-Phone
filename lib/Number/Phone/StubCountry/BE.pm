...
my $validators = {'personal_number' => '','toll_free' => '800\\d{5}','pager' => '','mobile' => '4(?:[67]\\d|8[3-9]|9[1-9])\\d{6}','voip' => '','fixed_line' => '(?:1[0-69]|[23][2-8]|[49][23]|5\\d|6[013-57-9]|7[18])\\d{6}|8(?:0[1-9]|[1-69]\\d)\\d{5}','special_rate' => '(87\\d{6})|((?:90|7[07])\\d{6})|()'};
sub new {
  my $class = shift;
  my $number = shift;
  $number =~ s/(^\+32|\D)//g;
