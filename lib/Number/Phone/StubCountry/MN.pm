...
my $validators = {'toll_free' => '','fixed_line' => '[12](?:1\\d|2(?:[1-3]\\d?|7\\d)|3[2-8]\\d{1,2}|4[2-68]\\d{1,2}|5[1-4689]\\d{1,2})\\d{5}|5[0568]\\d{6}','geographic' => '[12](?:1\\d|2(?:[1-3]\\d?|7\\d)|3[2-8]\\d{1,2}|4[2-68]\\d{1,2}|5[1-4689]\\d{1,2})\\d{5}|5[0568]\\d{6}','pager' => '','special_rate' => '()|()|()','mobile' => '(?:8[689]|9[013-9])\\d{6}','personal_number' => '','voip' => '7[05-8]\\d{6}'};
sub new {
  my $class = shift;
  my $number = shift;
  $number =~ s/(^\+976|\D)//g;
