...
my $validators = {'personal_number' => '','pager' => '','voip' => '','fixed_line' => '[2-8]\\d{7,8}','special_rate' => '()|(900\\d{6})|()','toll_free' => '800\\d{6}','geographic' => '[2-8]\\d{7,8}','mobile' => '9\\d{8}'};sub areaname { my $self = shift; my $number = $self->{number}; my %map = (8862 => "Taipei",8863 => "Taoyuan\/Hsinchu\/Yilan\/Hualien",88637 => "Miaoli",8864 => "Taichung\/Changhua",88649 => "Nantou",8865 => "Chiayi\/Yunlin",8866 => "Tainan\/Penghu",8867 => "Kaohsiung",8868 => "Pingtung",88682 => "Kinmen",886826 => "Wuqiu",886836 => "Matsu",88689 => "Taitung",);
