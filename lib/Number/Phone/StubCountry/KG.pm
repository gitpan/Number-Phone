...
my $validators = {'toll_free' => '800\\d{6,7}','mobile' => '(?:20[0-35]|5[124-7]\\d|7[07]\\d)\\d{6}','voip' => '','fixed_line' => '(?:3(?:1(?:[256]\\d|3[1-9]|47)|2(?:22|3[0-479]|6[0-7])|4(?:22|5[6-9]|6\\d)|5(?:22|3[4-7]|59|6\\d)|6(?:22|5[35-7]|6\\d)|7(?:22|3[468]|4[1-9]|59|[67]\\d)|9(?:22|4[1-8]|6\\d))|6(?:09|12|2[2-4])\\d)\\d{5}','special_rate' => '()|()|()','personal_number' => '','pager' => '','geographic' => '(?:3(?:1(?:[256]\\d|3[1-9]|47)|2(?:22|3[0-479]|6[0-7])|4(?:22|5[6-9]|6\\d)|5(?:22|3[4-7]|59|6\\d)|6(?:22|5[35-7]|6\\d)|7(?:22|3[468]|4[1-9]|59|[67]\\d)|9(?:22|4[1-8]|6\\d))|6(?:09|12|2[2-4])\\d)\\d{5}'};
sub new {
  my $class = shift;
  my $number = shift;
  $number =~ s/(^\+996|\D)//g;
