...
my $validators = {'personal_number' => '1700\\d{6}','toll_free' => '1[38]00\\d{6}','pager' => '','mobile' => '1(?:[02-46-9][2-9]|11\\d)\\d{6}','voip' => '154\\d{7}','fixed_line' => '(?:3\\d{2}|[4-79]\\d|8[2-9])\\d{6}','special_rate' => '()|(1600\\d{6})|()'};
sub new {
  my $class = shift;
  my $number = shift;
  $number =~ s/(^\+60|\D)//g;
