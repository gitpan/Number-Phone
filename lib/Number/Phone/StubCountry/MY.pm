...
my $validators = {'personal_number' => '1700\\d{6}','toll_free' => '1[38]00\\d{6}','pager' => '','mobile' => '1(?:1[1-3]\\d{2}|[02-4679][2-9]\\d|59\\d{2}|8(?:1[23]|[2-9]\\d))\\d{5}','voip' => '154\\d{7}','fixed_line' => '(?:3[2-9]\\d|[4-9][2-9])\\d{6}','special_rate' => '()|(1600\\d{6})|()'};
sub new {
  my $class = shift;
  my $number = shift;
  $number =~ s/(^\+60|\D)//g;
