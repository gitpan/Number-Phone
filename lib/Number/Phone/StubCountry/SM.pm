...
my $validators = {'personal_number' => '','special_rate' => '()|(7[178]\\d{6})|()','mobile' => '6[16]\\d{6}','fixed_line' => '0549(?:8[0157-9]|9\\d)\\d{4}','voip' => '5[158]\\d{6}','geographic' => '0549(?:8[0157-9]|9\\d)\\d{4}','pager' => '','toll_free' => ''};
sub new {
  my $class = shift;
  my $number = shift;
  $number =~ s/(^\+378|\D)//g;
