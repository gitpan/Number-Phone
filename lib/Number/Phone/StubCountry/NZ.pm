...
my $validators = {'fixed_line' => '(?:3[2-79]|[49][2-689]|6[235-9]|7[2-5789])\\d{6}|24099\\d{3}','voip' => '','pager' => '[28]6\\d{6,7}','mobile' => '2(?:[028]\\d{7,8}|1(?:[03]\\d{5,7}|[12457]\\d{5,6}|[689]\\d{5})|[79]\\d{7})','special_rate' => '()|(90\\d{7,9})|()','personal_number' => '','toll_free' => '508\\d{6,7}|80\\d{6,8}','geographic' => '(?:3[2-79]|[49][2-689]|6[235-9]|7[2-5789])\\d{6}|24099\\d{3}'};
sub new {
  my $class = shift;
  my $number = shift;
  $number =~ s/(^\+64|\D)//g;
