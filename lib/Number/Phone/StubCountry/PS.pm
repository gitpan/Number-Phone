...
my $validators = {'special_rate' => '(1700\\d{6})|(1(?:4|9\\d)\\d{2})|()','geographic' => '(?:22[234789]|42[45]|82[01458]|92[369])\\d{5}','toll_free' => '1800\\d{6}','personal_number' => '','fixed_line' => '(?:22[234789]|42[45]|82[01458]|92[369])\\d{5}','mobile' => '5[69]\\d{7}','voip' => '','pager' => ''};
sub new {
  my $class = shift;
  my $number = shift;
  $number =~ s/(^\+970|\D)//g;
