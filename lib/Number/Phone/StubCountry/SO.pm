...
my $validators = {'personal_number' => '','toll_free' => '','pager' => '','mobile' => '(?:15\\d|2(?:4\\d|8)|6[17-9]?\\d{2}|7\\d{2}|9(?:07|1)\\d)\\d{5}','voip' => '','fixed_line' => '(?:[134]\\d|2[0-79]|5[57-9])\\d{5}','special_rate' => '()|()|()'};sub areaname { my $self = shift; my $number = $self->{number}; my %map = (2521 => "Hargeisa",25251 => "Mangauno",25261 => "Mogadishu",);
