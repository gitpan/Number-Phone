...
my $validators = {'toll_free' => '800\\d{6}','mobile' => '7[238]\\d{7}','voip' => '','fixed_line' => '2[258]\\d{7}|06\\d{6}','special_rate' => '()|(900\\d{6})|()','personal_number' => '','pager' => '','geographic' => '2[258]\\d{7}|06\\d{6}'};
sub new {
  my $class = shift;
  my $number = shift;
  $number =~ s/(^\+250|\D)//g;
