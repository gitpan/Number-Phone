...
my $validators = {'mobile' => '(?:7[578]|8[7-9])\\d{5}','geographic' => '(?:2\\d|3[1-8]|4[1-4]|[56]0|7[0149]|8[05])\\d{3}','toll_free' => '0800\\d{3}','fixed_line' => '(?:2\\d|3[1-8]|4[1-4]|[56]0|7[0149]|8[05])\\d{3}','special_rate' => '()|()|()','voip' => '','pager' => '','personal_number' => ''};
sub new {
  my $class = shift;
  my $number = shift;
  $number =~ s/(^\+676|\D)//g;
