...
my $formatters = [];
my $validators = {'voip' => '','personal_number' => '','geographic' => '18[1-8]\\d{3,9}','toll_free' => '800\\d{4,7}','fixed_line' => '18[1-8]\\d{3,9}','mobile' => '4\\d{5,10}|50\\d{4,8}','pager' => '','special_rate' => '()|([67]00\\d{5,6})|([13]0\\d{4,8}|2(?:0(?:[016-8]\\d{3,7}|[2-59]\\d{2,7})|9\\d{4,8})|60(?:[12]\\d{5,6}|6\\d{7})|7(?:1\\d{7}|3\\d{8}|5[03-9]\\d{2,7}))'};sub areaname { my $self = shift; my $number = $self->{number}; my %map = (35813 => "North\ Karelia",35814 => "Central\ Finland",35815 => "Mikkeli",35816 => "Lapland",35817 => "Kuopio",35818 => "\Ã\…land\ Islands",35819 => "Nylandia",3582 => "Turku\/Pori",3583 => "Tavastia",35851 => "Kymi",35852 => "Kymi",35853 => "Kymi",35854 => "Kymi",35855 => "Kymi",35856 => "Kymi",35857 => "Kymi",35858 => "Kymi",3586 => "Vaasa",3588 => "Oulu",3589 => "Helsinki",);
