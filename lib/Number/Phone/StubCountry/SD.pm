...
my $validators = {'toll_free' => '','mobile' => '9[012569]\\d{7}','voip' => '','fixed_line' => '1(?:[125]\\d|8[3567])\\d{6}','special_rate' => '()|()|()','personal_number' => '','pager' => '','geographic' => '1(?:[125]\\d|8[3567])\\d{6}'};sub areaname { my $self = shift; my $number = $self->{number}; my %map = (24911 => "Omdurman",24921 => "Atbara",249183 => "Khartoum",24931 => "Port\ Sudan",24941 => "Kassala",249441 => "Jedaraf",24951 => "Wadmedai",24961 => "Sennar",249616 => "Shetnzi",24971 => "Kosti",24981 => "Al\-Ubayyid",);
