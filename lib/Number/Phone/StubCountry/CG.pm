...
my $validators = {'fixed_line' => '222[1-589]\\d{5}','mobile' => '0[14-6]\\d{7}','pager' => '','voip' => '','special_rate' => '()|()|()','geographic' => '222[1-589]\\d{5}','toll_free' => '800\\d{6}','personal_number' => ''};sub areaname { my $self = shift; my $number = $self->{number}; my %map = (2422221 => "Cuvette",2422222 => "Likouala\/Sangha",2422223 => "Pool",2422224 => "Plateaux",2422225 => "Bouenza\/Lekoumou\/Niari",2422228 => "Brazzaville",2422229 => "Pointe\-Noire",);
